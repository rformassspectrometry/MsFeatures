...
The `MsFeatures` package providing key concepts and functions facilitating this
feature grouping. See also the description of the [general grouping
concept](https://rformassspectrometry.github.io/MsFeatures/reference/groupFeatures.html)
on the package webpage for more information. After definition of the feature
groups, the `r BiocStyle::Biocpkg("QFeatures")` package could be used to
aggregate their abundances into a single signal.
